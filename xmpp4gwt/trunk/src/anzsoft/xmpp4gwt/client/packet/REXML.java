...
public class REXML 
{
	...
	/*-{
		try
		{
	 		return this.@anzsoft.xmpp4gwt.client.packet.REXML::rootElement.childElements.length;
		}
		catch(e)
		{
			return 0;
	...
	/*-{
		try
		{
			return this.@anzsoft.xmpp4gwt.client.packet.REXML::rootElement.childElements[pos].attribute(attribute);
		}
		catch(e)
		{
			return null;
	...
	/*-{
		try
		{
			return this.@anzsoft.xmpp4gwt.client.packet.REXML::rootElement.childElements[pos].childElement(nodeName).text;
		}
		catch(e)
		{
			return null;
