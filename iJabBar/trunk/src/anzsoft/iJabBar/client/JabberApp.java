...
public class JabberApp 
{
	...
	public JabberApp()
	{
		...
		*/
		...
		if(debug == true)
		{
			DebugBox debugBox = new DebugBox((Bosh2Connector)session.getConnector());
			RootPanel.get().add(debugBox);
			debugBox.show();
		}
	}
	
	public void addLeftBarButton(String imgUrl,String tooltip,String url,String target)
	{
	...
	public void talkTo(String jid)
	{
		...
		if(contactView.getRenderMode() == RenderMode.Online || contactView.getRenderMode() == RenderMode.None)
