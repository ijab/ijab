...
public class ChatTextFormatter 
{
    ...
    */
    ...
    static String preFormatEmoticons(String message) 
    {
    	...
    	message = replace(message, new String[] {":-P",":-p",":P",":p"}, PICtongue);
    	message = replace(message, new String[] {":D",":d"}, PIC13);
    	message = replace(message, new String[] {":-D",":-d",":-&gt;",":&gt;"}, PICbiggrin);
    	message = replace(message, new String[] {":-\\(",":\\("}, PICunhappy);
    	message = replace(message, new String[] {":'-\\(",":'\\(",";-\\(",";\\("}, PICcry);
    	...
    	message = replace(message, new String[] {":-S",":-s",":S",":s"}, PICfrowning);
    	message = replace(message, new String[] {"B-\\)","B\\)","\\(H\\)","\\(h\\)"}, PIC101);
    	...
    	message = replace(message, new String[] {"\\(L\\)","\\(l\\)"}, PICheart);
    	message = replace(message, new String[] {"\\(U\\)","\\(u\\)"}, PICbrheart);
    	message = replace(message, new String[] {"\\(Y\\)","\\(y\\)"}, PICyes);
    	message = replace(message, new String[] {"\\(N\\)","\\(n\\)"}, PICno);
    	message = replace(message, new String[] {"\\(Z\\)","\\(z\\)"}, PICboy);
    	message = replace(message, new String[] {"\\(X\\)","\\(x\\)"}, PICgirl);
    	message = replace(message, new String[] {"\\(F\\)","\\(f\\)"}, PICflower);
    	message = replace(message, new String[] {"\\(W\\)","\\(w\\)"}, PICbrflower);
    	message = replace(message, new String[] {"\\(showlove\\)"}, PIC116);
    	message = replace(message, new String[] {"\\(B\\)","\\(b\\)"}, PICbeer);
    	message = replace(message, new String[] {"\\(C\\)","\\(c\\)"}, PICcoffee);
    	message = replace(message, new String[] {"\\(K\\)","\\(k\\)"}, PICkiss);
    ...
    private static String formatEmoticons(String message) 
    {
        ...
        */
        ...
        message = message.replaceAll(PICfrowning, getImgSrcHtml("frowning.gif"));
        ...
        message = message.replaceAll(PICbrflower, getImgSrcHtml("brflower.gif"));
