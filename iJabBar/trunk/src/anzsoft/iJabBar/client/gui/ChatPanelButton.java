...
public class ChatPanelButton extends LayoutContainer 
{
	...
	public ChatPanelButton(ChatBox cb)
	{
		...
		setId("ijab_chatpanel_button_"+cb.getChatItem().getJid().toStringBare());
		...
		//create the xButton
		xButton = new ChatPanelXButton(new SelectionListener<ChatPanelXButtonEvent>()
		{
	...
	private String updateHitHtml()
	{
		String ret = 	"<div class='ijab_chatpanel_button_name'>"+
						   			"<span class='ijab_chatpanel_button_nametext'>"+
						   				nick +
						   			"</span>"+
						   			"<img src='"+GWT.getModuleBaseURL()+"images/spacer.gif' class='ijab_chatpanel_button_status'/>"+
						   	"</div>";
		return ret;
	}
