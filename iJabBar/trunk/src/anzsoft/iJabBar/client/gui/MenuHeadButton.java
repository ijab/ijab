...
public class MenuHeadButton extends BoxComponent
{
	  ...
	  */
	 public MenuHeadButton(String style, SelectionListener<MenuHeadButtonEvent> listener) 
	 {
		 this(style);
	  ...
	  * @param listener
	  */
	 public void addSelectionListener(SelectionListener<MenuHeadButtonEvent> listener) 
	 {
	  ...
	  */
	 public void removeSelectionListener(SelectionListener<MenuHeadButtonEvent> listener) 
	 {
