...
public class ChatPanel extends LayoutContainer implements ChatListener<ChatBox>,ContactViewListener,SessionListener
{
	...
	*/
	...
	public ChatPanel(ChatManager<ChatBox> manager)
	{
		...
		*/
		...
		rightScrollButton.setImgSrc(GWT.getModuleBaseURL()+"images/right.gif");
	...
	private void suspend()
	{
		...
		Cookies.setCookie("ijab_last_caht", lastActiveChat, null, null, "/", false);
