...
public class MenuHeader extends BoxComponent 
{
	...
	protected void onRender(Element target,int index)
	{
		...
		headerButtons = el().createChild("<div class='ijab_barmenu_header_buttons'></div>");
		if(haveCloseButton)
		{
			...
			closeButton.addSelectionListener(new SelectionListener<MenuHeadButtonEvent>()
			{
		...
		if(haveMinButton)
		{
			...
			minButton.addSelectionListener(new SelectionListener<MenuHeadButtonEvent>()
			{
				public void componentSelected(MenuHeadButtonEvent ce) 
				{
					fireOnMin();
		...
		headerText = el().createChild("<div class='ijab_barmenu_header_text'></div>");
